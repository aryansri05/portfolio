...
const lines = [
  ...
  { text: "- Benchmarked Sarvam 30B FP8 across NVIDIA H100 SXM, NVIDIA T4, and Apple M2 for real-world inference performance.", size: 10 },
  { text: "- Measured mean latency, P90/P95 latency, tokenization behavior, throughput trends, and hardware deployment tradeoffs.", size: 10 },
